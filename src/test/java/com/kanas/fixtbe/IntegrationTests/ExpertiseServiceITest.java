...
public class ExpertiseServiceITest {
    ...
    class ImplementedExpertiseITests {
        ...
        void getLogger_noErrorExpected() {
            ...
            assertEquals("com.kanas.fixtbe.service.impl.ExpertiseServiceImpl", logger.getName());
        }
        ...
        void getType_noErrorExpected() {
            ...
            assertEquals("class com.kanas.fixtbe.domain.entity.Expertise", expertiseType.toString());
        }
    }
}
