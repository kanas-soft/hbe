...
public class JobAdServiceITest {
    ...
    class ImplementedJobAdITests {
        ...
        void getLogger_noErrorExpected() {
            ...
            assertEquals("com.kanas.fixtbe.service.impl.JobAdServiceImpl", logger.getName());
        }
        ...
        void getType_noErrorExpected() {
            ...
            assertEquals("class com.kanas.fixtbe.domain.entity.JobAd", expertiseType.toString());
        }
    }
}
