...
public class ReviewServiceITest {
    ...
    class ImplementedReviewITests {
        ...
        void getLogger_noErrorExpected() {
            ...
            assertEquals("com.kanas.fixtbe.service.impl.ReviewServiceImpl", logger.getName());
        }
        ...
        void getType_noErrorExpected() {
            ...
            assertEquals("class com.kanas.fixtbe.domain.entity.Review", reviewType.toString());
        }
    }
}
